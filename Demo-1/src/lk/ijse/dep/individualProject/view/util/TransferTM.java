...
public class TransferTM {
    ...
    public TransferTM(int fromAccountID, int toAccountID, String fromAccountName, String toAccountName, int fromTransactionID, int toTransactionID, int transferValue) {
